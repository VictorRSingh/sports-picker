        ...
        {playerObject.position === "QUARTERBACK" ? (
          <>
            <h1>
              ...
              {getQuarterbackPassingAverage(gameLogs).toFixed(1)}
            </h1>
            <h1>
              Completions Average:{" "}
              {getQuarterbackCompletionsAverage(gameLogs).toFixed(1)}
            </h1>
            <h1>
          ...
          <>
            <h1>
              ...
              {getRunningBackRushingAttemptsAverage(gameLogs).toFixed(1)}
            </h1>
            <h1>
              Rushing Yards Average:{" "}
              {getRunningBackRushingYardsAverage(gameLogs).toFixed(1)}
            </h1>
            <h1>
              Rushing Yards Per Attempt Average:{" "}
          ...
          <>
            <h1>
              Receptions Average:{" "}
              {getWideReceiverReceptionsAverage(gameLogs).toFixed(1)}
            </h1>
            <h1>
              Receiving Yards Average:{" "}
              {getWideReceiverReceivingYardsAverage(gameLogs).toFixed(1)}
            </h1>
            <h1>
              Receiving Touchdowns Average:{" "}
          ...
          <>
            <h1>
              Receptions Average:{" "}
              {getTightEndReceptionsAverage(gameLogs).toFixed(1)}
            </h1>
            <h1>
              Receiving Yards Average:{" "}
              {getTightEndReceivingYardsAverage(gameLogs).toFixed(1)}
            </h1>
          </>
        ) : (
